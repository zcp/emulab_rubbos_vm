...
//  public String authenticate(String nickname, String password, Connection conn)
  public String authenticate(String nickname, String password, Connection conn, String urlID, StringBuilder logTmpMessage)
  {
    try
    {
      PreparedStatement stmt = conn
          ...
          .prepareStatement("SELECT id FROM users WHERE nickname='" + nickname
//ChienAn              + "' AND password='" + password + "'",
              + "' AND password='" + password + "'" + " /* " + urlID + " */",
...
//  public String getUserName(int UserId, Connection conn) throws Exception
  public String getUserName(int UserId, Connection conn, String urlID, StringBuilder logTmpMessage) throws Exception
  {
    try
    {
      PreparedStatement stmt = conn
//ChienAn          .prepareStatement("SELECT nickname FROM users WHERE id=?",
          .prepareStatement("SELECT nickname FROM users WHERE id=?" + " /* " + urlID + " */",
            // Yasu: FORWARD_ONLY ResultSet doesn't support first() method.
	    ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
