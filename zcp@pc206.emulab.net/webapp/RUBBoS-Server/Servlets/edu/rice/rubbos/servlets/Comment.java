...
//      int filter) throws Exception
  public static void displayFilterChooser(Connection conn, ServletPrinter sp,
      int commentId, String storyId, String commentTable, int display,
      int filter, String urlID, StringBuilder logTmpMessage) throws Exception
  {
    int i, count, rating;
...
//ChienAn        + " GROUP BY rating ORDER BY rating",
        + " GROUP BY rating ORDER BY rating" + " /* urlID=" + urlID + " */",
	...
	logTmpMessage.append(" DBST(nano)=" + startNano + " DBET(nano)=" + endNano + " DBRT(us)=" + responseTime);
...
//      throws SQLException
  private static void fetchLowerLevels(HashMap map, int level, Connection conn,
      int filter, int commentId, String commentTable, String storyId, int cid, int display, String urlID, StringBuilder logTmpMessage)
      throws SQLException
  {
...
//ChienAn    + storyId;
    ...
    */
    ...
    if (deeper) 
    { 
//ChienAn      fetchLowerLevels(map, level+1, conn, filter, commentId, commentTable, storyId, cid, display);
      fetchLowerLevels(map, level+1, conn, filter, commentId, commentTable, storyId, cid, display, urlID, logTmpMessage);
    }
...
//  throws SQLException
  private static HashMap fetchComments(Connection conn, int filter,
      int commentId, String commentTable, String storyId, int parent, int display, String urlID, StringBuilder logTmpMessage)
  throws SQLException
  {
...
//ChienAn      + ".writer=users.id";
      + ".writer=users.id" + " /* " + urlID + " */";
      /*
...
//          parent, display);
      fetchLowerLevels(map, 1, conn, filter, commentId, commentTable, storyId,
          parent, display, urlID, logTmpMessage);
    }
...
//      String storyId, int parent) throws Exception
  public static void fetchAndDisplay(ServletPrinter sp, Connection conn,
      String commentTable, int filter, int commentId, int display,
      String storyId, int parent, String urlID, StringBuilder logTmpMessage) throws Exception
  {
//ChienAn
