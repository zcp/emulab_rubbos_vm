...
{
	//ChienAn
	static Logger responseTimeLogger = Logger.getLogger(OlderStories.class);
    ...
    else
    {
      ...
      try
      {
        stmt = conn.prepareStatement("SELECT stories.id, stories.title, "
            ...
            // + nbOfStories,
            + " ORDER BY date DESC LIMIT " + nbOfStories + " OFFSET "
//ChienAn            + page * nbOfStories,
            + page * nbOfStories + " /* urlID=" + request.getParameter("urlID") + " */",
