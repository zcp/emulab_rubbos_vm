...
public class Config
{
  ...
  public static final String HTMLFilesPath                 = "/tmp/RUBBoS/Servlet_HTML";
  public static final String[] DatabaseProperties          = {"/tmp/RUBBoS/mysql.properties"};
  public static final int DatabasePropertiesSize = 1;

  public static final int    AboutMePoolSize               = 10;
  public static final int    BrowseCategoriesPoolSize      = 24;
  ...
  public static final int    Log4jInit			   = 1;
}
