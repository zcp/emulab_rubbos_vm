...
{
	//ChienAn
	static Logger responseTimeLogger = Logger.getLogger(ModerateComment.class);
...
//ChienAn          + " WHERE id=" + commentId,
    ...
    try
    {
      ...
      String username = sp.getUserName(rs.getInt("writer"), conn, request.getParameter("urlID"), logTmpMessage);
