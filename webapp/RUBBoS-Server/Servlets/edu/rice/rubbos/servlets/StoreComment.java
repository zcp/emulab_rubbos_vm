...
{
	//ChienAn
	static Logger responseTimeLogger = Logger.getLogger(StoreComment.class);
      ...
      throws IOException, ServletException
  {
    ...
    userIdstring = sp.authenticate(nickname, password, conn, request.getParameter("urlID"), logTmpMessage);
...
//ChienAn          + ", 0, 0, NOW(), '" + subject + "', '" + body + "')");
          + ", 0, 0, NOW(), '" + subject + "', '" + body + "')" + " /* urlID=" + request.getParameter("urlID") + " */");
...
//ChienAn          + " SET childs=childs+1 WHERE id=" + parent);
          + " SET childs=childs+1 WHERE id=" + parent + " /* urlID=" + request.getParameter("urlID") + " */");
