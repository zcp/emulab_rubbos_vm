...
public abstract class URLGenerator
{
 ...
 /**
  ...
  public URL homePage()
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+StoriesOfTheDayScript()+"?urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL register()
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, HTMLPath+"/register.html"+"?urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
                         ...
                         String email, String password)
  {
    try
    {
      ...
      lastname+"&nickname="+nickname+"&email="+email+"&password="+password+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL browse()
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, HTMLPath+"/browse.html"+"?urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL browseCategories()
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+BrowseCategoriesScript()+"?urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL OlderStories(int day, int month, int year, int page, int nbOfStories)
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+OlderStoriesScript()+
                        "?day="+day+"&month="+month+"&year="+year+"&page="+page+"&nbOfStories="+nbOfStories+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL browseStoriesByCategory(int categoryId, String categoryName, int page, int nbOfStories)
  {
    try
    {
      ...
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+BrowseStoriesByCategoryScript()+
                        "?category="+categoryId+"&categoryName="+categoryName+"&page="+page+"&nbOfStories="+nbOfStories+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL viewStory(int storyId)
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+ViewStoryScript()+"?storyId="+storyId+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
 ...
 /**
  ...
  public URL search(String keyword, String searchType, int page, int nbOfStories)
  {
    try
    {
      URL url;
      if (keyword == null)
        url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+SearchScript()+"?urlID="+System.nanoTime());
      else
        url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+SearchScript()+
                      "?type="+URLEncoder.encode(searchType)+"&search="+URLEncoder.encode(keyword)+"&page="+page+"&nbOfStories="+nbOfStories+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL postComment(int storyId, int parent, String comment_table)
  {
    try
    {
      ...
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+PostCommentScript()+"?storyId="+storyId+"&parent="+parent+"&comment_table="+comment_table+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL storeComment(String name, String pwd, int storyId, int parent, String subject, String body, String comment_table)
  {
    try
    {
      ...
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+StoreCommentScript()+"?comment_table="+comment_table
                        +"&nickname="+name+"&password="+pwd+"&storyId="+storyId+"&parent="+parent+"&subject="+subject+"&body="+body+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL viewComment(int commentId, int filter, int display, int storyId, String comment_table)
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+ViewCommentScript()+"?commentId="+commentId+"&filter="+filter+
                        "&display="+display+"&storyId="+storyId+"&comment_table="+comment_table+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL moderateComment(int commentId, String comment_table)
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+ModerateCommentScript()+
                        "?commentId="+commentId+"&comment_table="+comment_table+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL storeModerateLog(String name, String pwd, int commentId, int rating, String comment_table)
  {
    try
    {
      ...
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+StoreModerateLogScript()+"?comment_table="+comment_table
                        +"&nickname="+name+"&password="+pwd+"&commentId="+commentId+"&rating="+rating+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
 ...
 /** URL to the Submit Story script.
  ...
  public URL submitStory()
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+SubmitStoryScript()+"?urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL storeStory(String name, String pwd, String title, String body, int categoryId)
  {
    try
    {
      ...
      body = URLEncoder.encode(body);
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+StoreStoryScript()+"?nickname="+name+"&password="+pwd+"&category="+categoryId+"&title="+title+"&body="+body+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL authorLogin()
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, HTMLPath+"/author.html"+"?urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL authorTasks(String name, String pwd)
  {
    try
    {
      name = URLEncoder.encode(name);
      pwd  = URLEncoder.encode(pwd);
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+AuthorTasksScript()+"?nickname="+name+"&password="+pwd+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL reviewStories()
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+ReviewStoriesScript()+"?urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL acceptStory(int storyId)
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+AcceptStoryScript()+"?storyId="+storyId+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
  ...
  public URL rejectStory(int storyId)
  {
    try
    {
      URL url = new URL(protocol, webSiteName, webSitePort, scriptPath+"/"+RejectStoryScript()+"?storyId="+storyId+"&urlID="+System.nanoTime());
      return url;
    }
    catch (java.net.MalformedURLException e)
    {
