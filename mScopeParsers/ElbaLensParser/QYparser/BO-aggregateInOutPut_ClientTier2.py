...
#plist_file = "QueueLength2-Apache4.csv"
...
output_file =  timeSpan + "_Apache4_multiplicity_wl_2" + workload + "-50ms.csv"
output_file2 = timeSpan + "_Apache4_responsetime_wl_2" + workload + "-50ms.csv"
output_file3 = timeSpan + "_Apache4_inout_wl_2" + workload + "-50ms.csv"
...
#output_file =  timeSpan + "_Tomcat4_multiplicity_wl" + workload + "-50ms.csv"
#output_file2 = timeSpan + "_Tomcat4_responsetime_wl" + workload + "-50ms.csv"
#output_file3 = timeSpan + "_Tomcat4_inout_wl" + workload + "-50ms.csv"
