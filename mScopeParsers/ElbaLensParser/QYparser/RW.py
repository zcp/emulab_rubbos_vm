...
#--------------------------------------------------------------------------------
# Input file
#plist_file = "RoundTrip-Client.csv"

#plist_file = timeSpan + ".plist"
#plist_file = "detailRT-" + workload + ".csv"

#plist_file = "Apache.csv"
#plist_file = "RoundTrip-Apache.csv"
plist_file = "QueueLength-" + node + ".csv"

#plist_file = "Tomcat.csv"
#plist_file = "RoundTrip-Tomcat.csv"
#plist_file = "QueueLength-Tomcat.csv"

#plist_file = "CJDBC.csv"
#plist_file = "RoundTrip-CJDBC.csv"
#plist_file = "RoundTrip-Mysql.csv"
#plist_file = "QueueLength-CJDBC.csv"

#plist_file = "Mysql1.csv"
#plist_file = "Mysql2.csv"
#plist_file = "QueueLength-Mysql.csv"

# Output files
#output_file =  timeSpan + "_Clienthttp_multiplicity_wl" + workload + "-50ms.csv"

#output_file =  timeSpan + "_Client_multiplicity_wl" + workload + "-50ms.csv"
#output_file2 = timeSpan + "_Client_responsetime_wl" + workload + "-50ms.csv"
#output_file3 = timeSpan + "_Client_inout_wl" + workload + "-50ms.csv"
output_file =  timeSpan + "_" + node + "_multiplicity_wl" + workload + "-50ms.csv"
output_file2 = timeSpan + "_" + node + "_responsetime_wl" + workload + "-50ms.csv"
output_file3 = timeSpan + "_" + node + "_inout_wl" + workload + "-50ms.csv"
#output_file =  timeSpan + "_Apache_multiplicity_wl" + workload + "-50ms.csv"
#output_file2 = timeSpan + "_Apache_responsetime_wl" + workload + "-50ms.csv"
#output_file3 = timeSpan + "_Apache_inout_wl" + workload + "-50ms.csv"
#output_file =  timeSpan + "_Tomcat_multiplicity_wl" + workload + "-50ms.csv"
#output_file2 = timeSpan + "_Tomcat_responsetime_wl" + workload + "-50ms.csv"
#output_file3 = timeSpan + "_Tomcat_inout_wl" + workload + "-50ms.csv"
...
#output_file =  timeSpan + "_CJDBC_multiplicity_wl" + workload + "-50ms.csv"
#output_file2 = timeSpan + "_CJDBC_responsetime_wl" + workload + "-50ms.csv"
#output_file3 = timeSpan + "_CJDBC_inout_wl" + workload + "-50ms.csv"
#output_file =  timeSpan + "_CJDBCAll_multiplicity_wl" + workload + "-50ms.csv"
#output_file2 = timeSpan + "_CJDBCAll_responsetime_wl" + workload + "-50ms.csv"
#output_file3 = timeSpan + "_CJDBCAll_inout_wl" + workload + "-50ms.csv"
...
#output_file =  timeSpan + "_Mysql1_multiplicity_wl" + workload + "-50ms.csv"
#output_file2 = timeSpan + "_Mysql1_responsetime_wl" + workload + "-50ms.csv"
#output_file3 = timeSpan + "_Mysql1_inout_wl" + workload + "-50ms.csv"
#output_file =  timeSpan + "_Mysql2_multiplicity_wl" + workload + "-50ms.csv"
#output_file2 = timeSpan + "_Mysql2_responsetime_wl" + workload + "-50ms.csv"
#output_file3 = timeSpan + "_Mysql2_inout_wl" + workload + "-50ms.csv"
